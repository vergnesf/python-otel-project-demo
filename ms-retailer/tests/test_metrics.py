"""Tests for business metrics counters in ms-retailer."""
...
def test_beer_orders_failed_increments_on_error_rate(metric_reader):
...
def test_beer_orders_created_increments_on_success(metric_reader):
    before = _get_counter_value(metric_reader, "beer_orders.created")
